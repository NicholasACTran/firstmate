...
FM_BUSY_GUARD_ESCAPE_SECS=300      # max seconds the busy guard may keep deferring while the composer reads provably empty before inject_msg delivers anyway; 0 disables the escape
